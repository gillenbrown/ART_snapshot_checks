...
$(galaxy_comparison_sentinel): $(galaxies) $(galaxies_comparison_script) $(plot_utils_script)
...
$(halo_growth_plot): $(merger_sentinels) $(halo_growth_comp_script) $(plot_utils_script)
