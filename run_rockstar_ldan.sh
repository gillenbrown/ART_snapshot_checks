...
# Lou analysis machines have Skylake nodes with 20 cores, where we have 
# 4 processes using 5 cores
/pleiades/u/scicon/tools/bin/several_tries mpiexec -np 5 python ./halo_finding_rockstar.py $1 $2 $3
