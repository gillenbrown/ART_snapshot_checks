...
def nbody_projection_all_species(ds, center, plot_width, axes_unit, savename):
    ...
    plot = yt.ProjectionPlot(ds, "x", n_body_density_field, 
                             center=center, width=plot_width, 
                             data_source=box, axes_unit=axes_unit)
    plot.annotate_timestamp(redshift=True, corner='upper_left', time_unit="Gyr",
